...
with tab1:
    ...
    jeniskelamin3 = jeniskelamin2.groupby(['Kabupaten/Kota', 'Kecamatan', 'Jenis Kelamin'])['Jumlah Penduduk'].sum().reset_index()
...
with tab2:
    ...
    statuskawin = statuskawin2.groupby(['Kabupaten/Kota', 'Kecamatan', 'Status Kawin'])['Jumlah Penduduk'].sum().reset_index()
...
with tab3:
    ...
    agama = agama2.groupby(['Kabupaten/Kota', 'Kecamatan', 'Agama'])['Jumlah Penduduk'].sum().reset_index()
...
with tab4:
    ...
    umur = umur2.groupby(['Kabupaten/Kota', 'Kecamatan', 'Kelompok Umur'])['Jumlah Penduduk'].sum().reset_index()
...
with tab5:
    ...
    pendidikan = pendidikan2.groupby(['Kabupaten/Kota', 'Kecamatan', 'Pendidikan'])['Jumlah Penduduk'].sum().reset_index()
...
with tab6:
    ...
    goldar = goldar2.groupby(['Kabupaten/Kota', 'Kecamatan', 'Golongan Darah'])['Jumlah Penduduk'].sum().reset_index()
...
with tab7:
    ...
    usia = usia2.groupby(['Kabupaten/Kota', 'Kecamatan', 'Usia Pendidikan'])['Jumlah Penduduk'].sum().reset_index()
...
with tab8:
    ...
    pekerjaan = pekerjaan2.groupby(['Kabupaten/Kota', 'Kecamatan', 'Pekerjaan'])['Jumlah Penduduk'].sum().reset_index()
